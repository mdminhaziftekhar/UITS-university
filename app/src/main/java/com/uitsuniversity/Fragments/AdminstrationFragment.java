...
public class AdminstrationFragment extends Fragment {

    public AdminstrationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView webView = view.findViewById(R.id.webview_adminstration);
        ...
        webView.loadUrl("https://uits.edu.bd/office-of-the-board-of-trustees/");
